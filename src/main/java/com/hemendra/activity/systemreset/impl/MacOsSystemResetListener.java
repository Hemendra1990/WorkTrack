...
public class MacOsSystemResetListener implements SystemResetListener {
    ...
    public boolean isStartOfDay(LocalDateTime currentEventTime) {
        log.info("Checking if it's the start of the day on macOS...");
    ...
    public void resetSystemState() {
        log.info("Resetting system state on macOS.");
